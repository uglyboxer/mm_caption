...
def sequence_generator(tokenizer, max_length, descriptions, photos, vocab_size, batch_size=128):
    if not descriptions or not photos:
        raise NotImplementedError('No data yo.')
